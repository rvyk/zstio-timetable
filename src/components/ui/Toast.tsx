...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed z-[100] flex max-h-screen w-full flex-col-reverse gap-y-2 p-4 max-md:bottom-0 sm:top-auto sm:right-0 sm:bottom-0 sm:flex-col md:max-w-[380px]",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "border-lines text-primary/70 hover:bg-primary/5 hover:text-primary inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-xs font-medium transition-colors disabled:pointer-events-none disabled:opacity-50",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "text-primary/30 hover:text-primary absolute top-2 right-2 rounded-md p-1 opacity-0 transition-all focus:opacity-100 group-hover:opacity-100",
      className,
    )}
    toast-close=""
    {...props}
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn(
      "text-primary/45 mt-1 text-[11px] leading-snug",
      className,
    )}
    {...props}
  />
